<nav x-data="{ open: false, cartOpen: false }" class="bg-black">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
                <!-- Cart Icon -->
                <a @click="cartOpen = true" class="cursor-pointer">
                    <svg class="h-6 w-6 text-white hover:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.344 2m4.313 14L21 7H7m0 0L5 19m13 2a1 1 0 100-2 1 1 0 000 2zm-11-2a1 1 0 110-2 1 1 0 010 2zm11-2l-7 7m-4-4L9 17m0 0L3 7m3-4h18l-2 9m-4 4H7l1-4h8l-1.667 5M5 6l-2 3" />
                    </svg>
                </a>
                <a href="#" class="text-white hover:text-gray-300 text-sm font-medium">
                    Contact Us
                </a>
    ...
    <div x-show="cartOpen" 
        ...
        <div class="p-6 text-white h-full flex flex-col">
            ...
            <div class="mt-8">
                <button @click="cartOpen = false" class="bg-white text-black px-6 py-3 rounded-full hover:bg-gray-200 flex items-center justify-center w-full">
